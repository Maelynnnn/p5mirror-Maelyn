...
// interactions and movements
  // float_rabbit
// this has not learnt, so I change another way to achieve this
  // let x;
  //    let d;
  // console.log(int(millis())%5000);
  // if(int(millis())%5000 == 0){
  //    x = random(0, 450)
  //    d = random(0, 450)
  //    }
  
//   randomly appear rabbit
  if (count == 0){
    x = random(50, 350);
    d = random(50, 450); 
  }
  ...
  // text_background
  fill(255);
  rect(x - 115, d + 50, 230, 30);
  // text
  textSize(30);
  fill(0);
  text("Feed me please", x - 115, d + 75);
  
//   I want the rabbit appear randomly rather than constantly float, so I change this part
  // x = x + pace_1;
  // d = d + pace_3;
  // if (x > width - 50 ||x < 5){
  //   pace_1 = - pace_1
